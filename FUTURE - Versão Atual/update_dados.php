...
if (isset($_GET['email'])) {
    if(isset($_GET['atributo']) && $_GET['atributo'] == 'nome') {
        ...
        echo '<td><input type="text" id="nome2" name="nome2" pattern="^[A-Z][a-z]+( [A-Z][a-z]+)+$" required></td>';
        echo '</tr>';
        echo '<tr>';
    ...
    if(isset($_GET['atributo']) && $_GET['atributo'] == 'localidade') {
        ...
        echo '</select></td>';
        echo '<td><input type="text" id="outro" name="outro" pattern="^[a-zA-Z]+(\s[a-zA-Z]+|-[a-zA-Z]+)*$"';
        echo 'placeholder="Insira o nome do país" style="display: none;" required disabled></td>';
        echo '</tr>';
        echo '<tr>';
        echo '<td><select id="uf" name="uf" onchange="muda();">';
        echo '</select></td>';
        echo '<td><input type="text" id="outra" name="outra" pattern="^[a-zA-Z]+(\s[a-zA-Z]+|-[a-zA-Z]+)*$"';
        ...
        echo '</select></td>';
        echo '<td><input type="text" id="outra1" name="outra1" pattern="^[a-zA-Z]+(\s[a-zA-Z]+|-[a-zA-Z]+)*$"';
