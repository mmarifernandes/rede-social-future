    ...
    <?php
        ...
        if(isset($_GET['email']) && $_GET['email'] != null) {
            ...
            if(isset($login)) {
                ...
                echo "<table border=1>";
                echo "<tr><td>Ordernar<a href='".url("orderbya", "nome+asc", $login)."'>&#x25BE;</a><a href='".url("orderbya", "nome+desc", $login)."'>&#x25B4;</a></td><tr>";
                ...
                for ($page = 0; $page < ceil($total/$limit); $page++) {
                    echo (($offseta == $page*$limit) ? ($page+1) : "<a href=\"".url("offseta", $page*$limit, $login)."\">".($page+1)."</a>")." \n";
                }
