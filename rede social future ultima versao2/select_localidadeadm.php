...
echo "<table border=\"1\">\n";
echo "<tr>\n";
echo "<td><a title='Adicionar uma nova localidade' href=\"insert_localidadeadm.php\">&#x1F4C4;</a></td>\n";
...
while ($row = $results->fetchArray())
{
    ...
    echo "<tr>\n";
    echo "<td><a title='Alterar a cidade desta localidade' href=\"update_localidadeadm.php?cidade_codigo=" . $row["cidade_codigo"] . "\">&#x1F4DD;</a></td>\n";
    ...
    echo "<td><a title='Deletar esta localidade' href=\"delete_localidadeadm.php?cidade_codigo=" . $row["cidade_codigo"] . "\" onclick=\"return(confirm('Excluir " . $row["cidade_codigo"] . "?'));\">&#x1F5D1;</a></td>\n";
