...
if(isset($_GET['cidade_codigo'])) {
    ...
    echo '<form id="form" action="update_localidade.php?cidade_codigo='.$_GET['cidade_codigo'].'" method="post">';
    echo '<table>';
    echo '<tr>';
...
if (isset($_POST['outra1'])) {
    ...
    if ($result === null) {
        ...
        echo "<script> setTimeout(function () { window.open(\"select_localidade.php\",\"_self\"); }, 1000); </script>";
    } else {
