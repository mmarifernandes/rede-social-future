    ...
    <?php
        ...
        if(isset($_GET['email']) && $_GET['email'] != null) {
            ...
            if(isset($login)) {
                ...
                // caso exista a variável descrição cria um grupo/página
                ...
                // caso exista a variável campo e pesquisa procura o grupo selecionado
                if (isset($_POST['campo']) || isset($_GET['vfinal'])) {
                    ...
                    // echo "esse é o campo novo ". $camponovo;
                    if($camponovo == ' ') {
                    ...
                    if($camponovo == ' ') {
                        ...
                        echo "select nome, codigo from grupo where nome like '%" . $camponovo . "%' AND ativo = 1 order by ". $ordeby. " limit ".$limit. " offset ". $ofset;
                    }
                    $arraypesquisa = [];
                    $cont = 1;
                ...
                // se existir um erro imprime na tela, na parte do menu
                if (isset($_GET['error'])) {
                ...
                echo "</td></tr><tr><td><button id='button' name='confirma'>Criar grupo</button>";
